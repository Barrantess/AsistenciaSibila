...
// Primal solution
typedef struct {
  cpg_float    control_action;   // Your variable control_action
} CPG_Prim_t;
...
// Parameter deltas
typedef struct {
  cpg_float    *Initial_state;   // Delta of your parameter Initial_state
  cpg_float    *Reference_state;   // Delta of your parameter Reference_state
} CPG_Delta_t;
...
extern cpg_float cpg_params_vec[3];
...
extern cpg_float canon_q[2];
extern cpg_csc canon_A;
extern cpg_float canon_l[1];
extern cpg_float canon_u[1];
